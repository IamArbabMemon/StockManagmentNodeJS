...
const addStock = async (req, res, next) => {
  try {
    ...
    const usernames = reserveDataArray.map(
    ...
    return res
      ...
      .json({
        success: true,
        message: "reserve account has been added succesfully ",
      });
  } catch (error) {
    console.log(error);
    next(error);
  ...
  try {
    ...
    return res
      ...
      .json({
        success: true,
        message:
          "All reserve stocks has been fetched succesfully according to website with sum ",
        data,
      });
  } catch (error) {
    next(error);
...
const getStockByID = async (req, res, next) => {
  try {
    ...
    return res
      ...
      .json({
        success: true,
        message: "reserve stocks has been fetched succesfully by id ",
        stock,
      });
  } catch (error) {
    next(error);
...
const updateStockById = async (req, res, next) => {
  try {
    ...
    const updatedStock = await reserveAccounts.findByIdAndUpdate(id, stock, {
      new: true,
    });
    ...
    return res
      ...
      .json({
        success: true,
        message: "reserve stock has been updated succesfully ",
        updatedStock,
      });
  } catch (error) {
    next(error);
